...
func Bootstrapper(api libmachine.API, bootstrapperName string, cc config.ClusterConfig, n config.Node, r command.Runner) (bootstrapper.Bootstrapper, error) {
	var b bootstrapper.Bootstrapper
	var err error
	switch bootstrapperName {
	case bootstrapper.Kubeadm:
		b, err = kubeadm.NewBootstrapper(api, cc, n, r)
		if err != nil {
